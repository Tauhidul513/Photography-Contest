...
public class AddNewEntry extends javax.swing.JFrame {
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(title, javax.swing.GroupLayout.DEFAULT_SIZE, 329, Short.MAX_VALUE)
                                    .addComponent(pg))))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            s.executeUpdate("insert into ENTRIES values('"+title.getText()+"','"+url.getText()+"','"+category.getText()+"',"+height.getText()+","+width.getText()+","+pg.getText()+",'"+camera.getText()+"','"+room.getText()+"')");
            conn.close();
            success=true;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddNewEntry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
